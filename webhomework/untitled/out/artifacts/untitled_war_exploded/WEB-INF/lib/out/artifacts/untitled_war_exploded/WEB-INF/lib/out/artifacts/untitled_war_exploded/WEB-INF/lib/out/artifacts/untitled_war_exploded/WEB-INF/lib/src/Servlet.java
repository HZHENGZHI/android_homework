...
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Cookie cookie[]=creat("182017242","0221901X",request,response);
        if(cookie==null)
        {
...
//        out.print(data);
    ...
    public  Cookie[] creat(String uid,String upw,HttpServletRequest request, HttpServletResponse response)
    {
